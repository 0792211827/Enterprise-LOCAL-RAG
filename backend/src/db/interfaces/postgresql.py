...
class PostgreSQLDatabase(BaseDatabase):
    ...
    def startup(self) -> None:
        ...
        try:
            ...
            # Import the domain models so they register on ``Base.metadata``
            # before table creation. Without this import the ORM classes are
            # never loaded and ``create_all`` would silently create nothing.
