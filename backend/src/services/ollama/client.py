...
class OllamaClient(LLMProvider):
    ...
    Implements the platform :class:`LLMProvider` interface so it can be used
    interchangeably with any other configured provider.
    """
        ...
        try:
            ...
            if response and "response" in response:
                ...
                if use_structured_output:
                    ...
                    # For plain text response, build a generic source structure
                    return {
                        "answer": answer_text,
